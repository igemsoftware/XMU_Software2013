...
public class RBSFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6264694003404595645L;
...
//					RBSFrame.this.sdSeq.setText(r.getSeq());
					...
					RBSFrame.this.site.setText(String.valueOf(r
							.getBestStartPoint()));
					RBSFrame.this.startCodon.setText(r.getStr());
	...
	class RBSImage extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -8609403185804781049L;
