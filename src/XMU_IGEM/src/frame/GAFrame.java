...
public class GAFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1498353758064509280L;
	...
	public void init() {
		...
		this.setBounds(parent.getBounds().width / 2 - 400 / 2,
				parent.getBounds().height / 2 - 385 / 2, 405, 400);
	...
	class GAImage extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 912153771210996969L;
	...
	private class MyAction implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			if (arg0.getSource() == confirm) {
				...
				// Algorithm al = new
				// Algorithm(s3,cell,population,daishu,crossRate,varRate);
