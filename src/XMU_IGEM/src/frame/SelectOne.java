...
public class SelectOne extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -502387074939054629L;

	public static void main(String[] args)
	{
		new SelectOne("AGATA","AGATATGAAC",1.0,1.0,1.0,1.0);
	}
	...
	public SelectOne(String p, String q, double minpgc, double minptm, double minqgc, double minqtm) {
...
//			System.out.println(id[i] + "\t" + name[i] + "\t" + seq[i]);
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == ok) {
				if(SelectOne.this.table.getSelectedRow()!=-1)
				{
					...
					new BestPrimer(p, q, SelectNotSigma, SelectOne.this.minpgc, SelectOne.this.minptm, SelectOne.this.minqgc, SelectOne.this.minqtm);
				}
			}
		}
	}
	...
	class Mytable extends AbstractTableModel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3484471950910329508L;
	...
	class SelectOneImage extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2781646979677753386L;
